...
<div class="snap-content" id="content-wrap">
    ...
    <div id="browse-sets" class="focused browse-sets" tabindex="-1">

        <div id="browse-search-bar" class="browse-search-bar icon-button hidden" tabindex="-1"> 
            <i class="fa fa-search" aria-hidden="true"></i>
            <span class="label hidden">검색</span>
        </div>
        <div class="youtube-logo-top hidden">
            <i class="kf kf-bi-01" aria-hidden="true"></i>
            <div class="youtube-unlimited-logo icon-youtube-red-logo"></div>
        </div>

        <div id="channel-header" class="collapsed one-button channel-header" tabindex="-1" style="background-image: url(&quot;https://yt3.ggpht.com/hSGNZzVg6SqeTLHMC0qOlqs-meaTWlssrqw43WLmmZXElnIbjO1JYQeCI1YRfpgtyvtHm_1jf5XUPno7_bg=w1920-fcrop64=1,00000000ffffffff-nd-c0xffffffff-rj-k-no&quot;);">
            <div class="browse-header-gradient"></div>
            <div class="browse-header-metadata">
                <div class="browse-header-avatar no-model image" data-image-url="{{avatarImageURL}}" tabindex="-1" style="background-image: url(&quot;//yt3.ggpht.com/4sPqsriwZVsZSG6xueahUvz0GCQa2fTh_wEt6S_qcnw6kqTKixgmrly_MRqLjR8HRvgkBCvkZLZJZgb1kAg=s100-nd-c-c0xffffffff-rj-k-no&quot;);"></div>
                <div class="title">노하우/스타일</div>
            </div>
            <div class="browse-header-button-bar no-model component" tabindex="-1">
                <div class="button browse-header-trailer hidden no-model icon-button" tabindex="-1"> 
                    <span class="icon icon-player-play"></span> 
                    <span class="label"></span>
                </div>
                <div class="button browse-header-subscribe  subscribe-button" tabindex="-1"> 
                    <span class="fa fa-youtube-play fa-lg"></span> 
                    <span class="label">구독</span>
                </div>
            </div>
        </div>
